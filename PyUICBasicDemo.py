...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bnClose.setText(_translate("MainWindow", "Turn off the device"))
        self.bnOpen.setText(_translate("MainWindow", "Open the device"))
        self.bnEnum.setText(_translate("MainWindow", "Find Device"))
        self.groupGrab.setTitle(_translate("MainWindow", "Collection"))
        self.bnSaveImage.setText(_translate("MainWindow", "Save the image"))
        self.radioContinueMode.setText(
            _translate("MainWindow", "Continuous Mode"))
        ...
        self.bnSoftwareTrigger.setText(
            _translate("MainWindow", "Soft trigger once"))
